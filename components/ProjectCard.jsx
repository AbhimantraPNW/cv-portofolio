...
const ProjectCard = ({ project }) => {
  return (
    <Card className="group overflow-hidden relative">
      ...
      bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light xl:dark:bg-work_project_bg_dark xl:bg-[100%]
      xl:bg-no-repeat overflow-hidden"
        >
          ...
          <div className="flex gap-x-4">
            ...
            flex justify-center items-center scale-0 opacity-0 group-hover:scale-90 
